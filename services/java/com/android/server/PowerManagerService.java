...
class PowerManagerService extends IPowerManager.Stub
    ...
    private static final boolean LOG_TOUCH_DOWNS = false;
    ...
    private static final int SHORT_KEYLIGHT_DELAY_DEFAULT = 500; // t+6 sec
    private static final int MEDIUM_KEYLIGHT_DELAY = 8000;       // t+15 sec
    private static final int LONG_KEYLIGHT_DELAY = 800;        // t+6 sec
    private static final int LONG_DIM_TIME = 1000;              // t+N-5 sec

    // How long to wait to debounce light sensor changes.
    private static final int LIGHT_SENSOR_DELAY = 90;
    ...
    */
    ...
    class BrightnessState implements Runnable {
        ...
        void setTargetLocked(int target, int stepsToTarget, int initialValue,
            ...
            mScreenOffHandler.postDelayed(this, 250);
        }
	...
	public void goToSleepIntermediate(long time) throws RemoteException {
		// TODO Auto-generated method stub
		
	}

	public boolean batteryIsCharging() throws RemoteException {
		// TODO Auto-generated method stub
		return false;
	}

	public String dump_power() throws RemoteException {
		// TODO Auto-generated method stub
		return null;
	}

	public void setAttentionLight(boolean flash, int color, int delay)
