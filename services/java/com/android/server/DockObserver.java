...
class DockObserver extends UEventObserver {
    ...
    private static final String DOCK_UEVENT_MATCH = "DEVPATH=/devices/virtual/switch/docking-device";
    private static final String DOCK_STATE_PATH = "/sys/class/switch/docking-device/state";
