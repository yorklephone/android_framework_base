...
class HeadsetObserver extends UEventObserver {
    ...
    private static final String HEADSET_UEVENT_MATCH = "DEVPATH=/devices/virtual/switch/headset-device";
    private static final String HEADSET_STATE_PATH = "/sys/class/switch/headset-device/state";
    private static final String HEADSET_NAME_PATH = "/sys/class/switch/headset-device/name";
