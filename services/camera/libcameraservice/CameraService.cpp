...
status_t CameraService::Client::registerPreviewBuffers() {
    ...
    LOGI("registerPreviewBuffers: previewFormat = %s and PixelFormat = %d", previewFormat, mPixelFormat);
#endif
#ifdef BOARD_USE_FROYO_LIBCAMERA
...
#endif
{
    LOGE("dataCallbackTimestamp(%d)", msgType);
