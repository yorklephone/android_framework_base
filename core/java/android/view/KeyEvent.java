...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_BUTTON_MODE     = 110;
        public static final int KEYCODE_RECENT     = 110;
    ...
    public static final int KEYCODE_MAGIC_VIEW = 247;//add KEYCODE_MAGIC_VIEW
    /*add hall sensor control*/
    public static final int KEYCODE_HALLSENSOR_CLOSE = 183;
    public static final int KEYCODE_HALLSENSOR_OPEN = 184;

    // Add Led Indication Option in Sound & Display Settings
    public static final int KEYCODE_SINGLE_CLICK    = 92;
	
/***RK_ID:RD_KeyEvent. DEP_RK_ID:NULL. AUT:liuxuhui@emails.bjut.edu.cn DATE:2010-07-28. END***/

 /*add by fish */
    public static final int KEYCODE_LEFT_RIGHT=130;
    public static final int KEYCODE_MENU_D=131;
    public static final int KEYCODE_PGUP=104;
    public static final int KEYCODE_PGDN=109;
    public static final int KEYCODE_KEYPAD_BACKGROUND_LIGHT=95;
   // public static final int KEYCODE_CTRL_LEFT=96;
   // public static final int KEYCODE_CTRL_RIGHT=97;
    public static final int KEYCODE_CAP_LEFT=159;  
    public static final int KEYCODE_CAP_RIGHT=160;
    public static final int KEYCODE_INPUT_SWITCH=99;
    public static final int KEYCODE_BACK_DOCK=135;
    public static final int KEYCODE_MENU_DOCK=136;	
/***RK_ID:RK_KEY. DEP_RK_ID:NULL. AUT:xieyan@gmail.com DATE:2010-12-03. START***/
    public static final int KEYCODE_INVALID = 137;
/***RK_ID:RK_KEY. DEP_RK_ID:NULL. AUT:xieyan@gmail.com DATE:2010-12-03. END***/
    ...
    private static final int LAST_KEYCODE           = KEYCODE_RECENT;
