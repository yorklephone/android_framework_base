...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Control whether the proximity sensor will be used
         * if 0, it will not be used
         * if 1, it will be used
         */
        public static final String PROXIMITY_SENSOR_ENABLED = "proximity_sensor_enabled";  
        ...
        /**
         * Whether to allow show recent app dialog by pressing
         * the device's left button.
         * @hide
         */
        public static final String SHOW_RECENT_APP_DIALOG = "show_recent_app_dialog";
        /**
         * Whether to allow show wake screen  by pressing
         * the device's magic button.
         * @hide
         */
        public static final String MAGIC_PRESS_WAKE_SCREEN = "magic_press_wake_screen";
        /**
         * Whether to allow lock screen  by pressing
         * the device's rocket down button.
         * @hide
         */
        public static final String DOWN_PRESS_LOCK_SCREEN = "down_press_lock_screen";
        /**
         * Whether to allow take photo  by pressing
         * the device's Magic button.
         * @hide
         */
        public static final String MAGIC_PRESS_TAKE_PHOTO = "magic_press_take_photo";
	...
	/**
        ...
        public static final String QUIET_HOURS_DIM = "quiet_hours_dim";
         /**
         * Whether to show lunar date
         * @hide
         */
        public static final String LOCKSCREEN_SHOW_LUNAR = "lockscreen_show_lunar";
     ...
     * the user must explicitly modify through the system UI or specializkied
