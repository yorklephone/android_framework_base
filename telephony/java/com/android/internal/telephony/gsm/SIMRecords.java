...
public final class SIMRecords extends IccRecords {
    ...
    private static final int EVENT_GET_CSP_CPHS_DONE = 38;
    private static final int EVENT_AUTO_SELECT_DONE = 300;

    // zhanglj add begin 2010-08-23 for get call forwarding from network (only for chinese SIM card)(linda)
    private static final int EVENT_GET_CFU_STATUS = 100;
