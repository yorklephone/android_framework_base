...
final class GsmServiceStateTracker extends ServiceStateTracker {
 ...
 //       int rule = phone.mSIMRecords.getDisplayRule(ss.getOperatorNumeric());
		...
		SpnOverride localSpnOverride = new SpnOverride();
		if(localSpnOverride.containsCarrier(ss.getOperatorNumeric()))
			plmn = localSpnOverride.getSpn(ss.getOperatorNumeric());
