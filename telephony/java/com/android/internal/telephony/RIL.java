...
public class RIL extends BaseCommands implements CommandsInterface {
    ...
    public void
		setRadioPowerOffWnc(Message result) {
			...
			RILRequest rr
					= RILRequest.obtain(RIL_REQUEST_RADIO_POWER_OFF_WNC, result);
...
*/
			...
			//{ radio power off but without power down SIM card , shihpei
            case RIL_REQUEST_RADIO_POWER_OFF_WNC: ret =  responseVoid(p); break;
...
*/
        switch(request) {
			...
			case RIL_REQUEST_RADIO_POWER_OFF_WNC: return "RADIO_POWER_OFF_WNC";
