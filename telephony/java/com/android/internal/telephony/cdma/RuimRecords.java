...
public final class RuimRecords extends IccRecords {
	...
	private static final int EVENT_GET_RUIM_ID_DONE = 6;
    ...
    public void handleMessage(Message msg) {
        ...
        try { switch (msg.what) {
			...
			case EVENT_GET_RUIM_ID_DONE:
				...
				int dataLength = data[0] & 0xFF;
				byte data_temp[] = new byte[dataLength];
				System.arraycopy(data, 1, data_temp, 0, dataLength);
				mRuimId = IccUtils.bytesToHexString(data_temp).toUpperCase();
				Log.d(LOG_TAG, "mRuimId: " + mRuimId);
            break;
			//end
