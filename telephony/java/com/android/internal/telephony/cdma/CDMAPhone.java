...
public class CDMAPhone extends PhoneBase {
    ...
    public String getLine1Number() {
		//merge by yejianchun to froyo at 2010 10.31
		//linda change fof get MdnNumber
	...
	//merge by yejianchun to froyo at 2010 10.31
	/* linda add for RUIM ID */
	public String getCdmaRuimId() {
		return mRuimRecords.getRuimId();
	}
	
    public String getMeid() {
		//merge by yejianchun to froyo at 2010 10.31
		//add by yejianchun for add parity for meid code at 2010 10.18		
		if(mMeid.length() >=14){
			mMeid = addParity(mMeid);
		}
        return mMeid;
    }
	...
	//merge by yejianchun to froyo at 2010 10.31
	//{ radio power off but without power down SIM card , shihpei
	public void setRadioPowerOffWnc(){
        mSST.setRadioPowerOffWnc();
	}
    //end
   ...
   /**
	...
	String addParity(String mMeid)
	{
	  ...
	  if(mMeid.length()!=14) mMeid = mMeid.substring(0,14);
	  char[] str = new char[14];
	  int[] itemp = new int[14];
	  str = mMeid.toCharArray();
      ...
      String s3="";
      s3 = Integer.toHexString(IMEI[14])+"";
	  s3 = s3.toUpperCase();
	  mMeid= new String(str);
	  mMeid=mMeid+s3;
	  return(mMeid);
	}
	//end
