...
public class TelephonyManager {
    ...
    public String getNetworkOperatorName() {
		//modify by yejianchun for obtain network service like china telcom
		if(true == "46003".equals(SystemProperties.get(TelephonyProperties.PROPERTY_OPERATOR_ALPHA))){
		   String china_telcom = mContext.getString(R.string.statusbar_plmn_china_telcom);
		   return china_telcom;
		}else {
    ...
    // zhanglj add 2010-08-23 for PUK lock(linda)
    public static final int SIM_STATE_PUK_LOCKED = 17;
